  ...
  <div class="row">
    ...
    <div class="col-sm">
      <div id="content" role="main">
        ...
        <?php if(have_posts()): ?>
          <?php get_template_part('includes/includes/includes/includes/includes/includes/loops/index-loop'); ?>
        <?php else: ?>
          <?php get_template_part('includes/includes/includes/includes/includes/includes/loops/index-none'); ?>
        <?php endif; ?>
      </div><!-- /#content -->
    </div>
